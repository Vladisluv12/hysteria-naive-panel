...
export function UsersPage() {
  ...
  const makeLink = (u: User) => {
    ...
    if (proxyType === 'vless') {
      ...
      return `vless://${encodeURIComponent(vuuid)}@${domain}:${vlessPort}?encryption=none&security=reality&sni=${domain}&fp=chrome&type=xhttp&path=/xhttp&mode=stream-one&pbk=${vlessPbk}#${encodeURIComponent(u.nickname || u.username)}`;
    }
    return '';
  };
